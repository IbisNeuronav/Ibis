...
#ifndef __ImageFullSamplerRandomOffset_txx
#define __ImageFullSamplerRandomOffset_txx

#include "itkImageFullSamplerRandomOffset.h"
...
namespace itk
{
  ...
  template< class TInputImage >
    void
    ImageFullSamplerRandomOffset< TInputImage >
    ::GenerateData( void )
  {
    ...
    else
    {
      ...
      for( iter.GoToBegin(); ! iter.IsAtEnd(); ++iter )
      {
        ...
        if ( mask->IsInside( tempsample.m_ImageCoordinates ) )
        {
          ...
          {
            tempsample.m_ImageCoordinates[d] += spacing[d]*(((double)rand()/(double)RAND_MAX)-0.5);
          }
...
#endif // end #ifndef __ImageFullSamplerRandomOffset_txx
