...
public:
  ...
  typedef FixedArray< double,
    itkGetStaticConstMacro(FixedImageDimension) >         KernelNormsType;
  ...
  itkGetConstMacro( FixedKernelNorms, KernelNormsType );
  itkSetMacro( FixedKernelNorms, KernelNormsType );
...
private:
  ...
  KernelNormsType 				  m_FixedKernelNorms;
  KernelNormsType 				  m_MovingKernelNorms;  
