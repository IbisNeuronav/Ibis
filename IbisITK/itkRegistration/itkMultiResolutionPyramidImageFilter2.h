/*=========================================================================
  ...
  Module:    $RCSfile: itkMultiResolutionPyramidImageFilter2.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkMultiResolutionPyramidImageFilter2_h
#define __itkMultiResolutionPyramidImageFilter2_h
...
/** \class MultiResolutionPyramidImageFilter2
 * \brief Framework for creating images in a multi-resolution
 * pyramid.
 *
 * MultiResolutionPyramidImageFilter2 provides a generic framework to
 ...
 *
 * \ingroup PyramidImageFilter2 Multithreaded Streamed
 */
template <
  class TInputImage, 
  class TOutputImage
  >
class ITK_EXPORT MultiResolutionPyramidImageFilter2 :
    public ImageToImageFilter< TInputImage, TOutputImage >
{
public:
  /** Standard class typedefs. */
  typedef MultiResolutionPyramidImageFilter2             Self;
  ...
  itkTypeMacro(MultiResolutionPyramidImageFilter2, ImageToImageFilter);
  ...
  /** MultiResolutionPyramidImageFilter2 produces images which are of
   * different resolution and different pixel spacing than its input image.
   * As such, MultiResolutionPyramidImageFilter2 needs to provide an
  ...
  /** MultiResolutionPyramidImageFilter2 requires a larger input requested
   * region than the output requested regions to accomdate the shrinkage and
   * smoothing operations. As such, MultiResolutionPyramidImageFilter2 needs
...
private:
  MultiResolutionPyramidImageFilter2(const Self&); //purposely not implemented
...
#include "itkMultiResolutionPyramidImageFilter2.txx"
#endif
