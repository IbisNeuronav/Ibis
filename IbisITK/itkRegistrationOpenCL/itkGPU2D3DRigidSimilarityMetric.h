...
class GPU2D3DRigidSimilarityMetric : public itk::SingleValuedCostFunction
{
public:


  typedef GPU2D3DRigidSimilarityMetric        Self;
  typedef itk::SingleValuedCostFunction     Superclass;
  typedef itk::SmartPointer<Self>           Pointer;
  typedef itk::SmartPointer<const Self>     ConstPointer;
  itkNewMacro( Self );
  itkTypeMacro( GPU2D3DRigidSimilarityMetric, SingleValuedCostFunction );
  ...
  typedef itk::GPU2D3DOrientationMatchingMatrixTransformationSparseMask<
