#==========================================================================
# This files was originally written by Andrew Hardin and copied from
# the following repository:
#
#   https://github.com/andrew-hardin/cmake-git-version-tracking
#
# Original MIT license in file LICENCE-gitwatcher
#==========================================================================
# git_watcher.cmake
#
...
#
#   GITWATCHER_PRE_CONFIGURE_FILE (REQUIRED)
#   -- The path to the file that'll be configured.
#
#   GITWATCHER_POST_CONFIGURE_FILE (REQUIRED)
#   -- The path to the configured GITWATCHER_PRE_CONFIGURE_FILE.
#
...
CHECK_REQUIRED_VARIABLE(GITWATCHER_PRE_CONFIGURE_FILE)
CHECK_REQUIRED_VARIABLE(GITWATCHER_POST_CONFIGURE_FILE)
CHECK_OPTIONAL_VARIABLE(GIT_STATE_FILE "${GITWATCHER_GIT_STATE_FILE}")
...
function(GitStateChangedAction _state_as_list)
    ...
    configure_file("${GITWATCHER_PRE_CONFIGURE_FILE}" "${GITWATCHER_POST_CONFIGURE_FILE}" @ONLY)
endfunction()
...
function(SetupGitMonitoring)
    add_custom_target(check_git_repository
        ALL
        DEPENDS ${GITWATCHER_PRE_CONFIGURE_FILE}
        BYPRODUCTS ${GITWATCHER_POST_CONFIGURE_FILE}
        ...
        COMMAND
            ...
            -DGITWATCHER_PRE_CONFIGURE_FILE=${GITWATCHER_PRE_CONFIGURE_FILE}
            -DGITWATCHER_POST_CONFIGURE_FILE=${GITWATCHER_POST_CONFIGURE_FILE}
