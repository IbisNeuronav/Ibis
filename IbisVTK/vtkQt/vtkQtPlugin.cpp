...
QString vtkQtHistogramWidgetPlugin::name() const { return "vtkQtHistogramWidget"; }

QString vtkQtHistogramWidgetPlugin::domXml() const
{
    return QLatin1String(
        "<widget class=\"vtkQtHistogramWidget\" name=\"vtkqthistogramwidget\">\n"
...
QString vtkQtHistogramWidgetPlugin::group() const { return "vtkQt"; }

QIcon vtkQtHistogramWidgetPlugin::icon() const { return QIcon( QPixmap( vtkQtPlugin_xpm ) ); }

QString vtkQtHistogramWidgetPlugin::includeFile() const { return "vtkQtHistogramWidget.h"; }

QString vtkQtHistogramWidgetPlugin::toolTip() const { return "Qt vtk histogram widget"; }

QString vtkQtHistogramWidgetPlugin::whatsThis() const { return "A Qt widget to display vtk histograms"; }

bool vtkQtHistogramWidgetPlugin::isContainer() const { return false; }
...
QString vtkQtPiecewiseFunctionWidgetPlugin::name() const { return "vtkQtPiecewiseFunctionWidget"; }

QString vtkQtPiecewiseFunctionWidgetPlugin::domXml() const
{
    return QLatin1String(
        "<widget class=\"vtkQtPiecewiseFunctionWidget\" name=\"vtkQtPiecewiseFunctionWidget\">\n"
        " <property name=\"geometry\">\n"
        "  <rect>\n"
        "   <x>0</x>\n"
        "   <y>0</y>\n"
...
QString vtkQtPiecewiseFunctionWidgetPlugin::group() const { return "vtkQt"; }

QIcon vtkQtPiecewiseFunctionWidgetPlugin::icon() const { return QIcon( QPixmap( vtkQtPlugin_xpm ) ); }

QString vtkQtPiecewiseFunctionWidgetPlugin::includeFile() const { return "vtkQtPiecewiseFunctionWidget.h"; }

QString vtkQtPiecewiseFunctionWidgetPlugin::toolTip() const { return "Qt vtkPiecewiseFunction edition widget"; }
...
bool vtkQtPiecewiseFunctionWidgetPlugin::isContainer() const { return false; }
...
QString vtkQtColorTransferFunctionWidgetPlugin::name() const { return "vtkQtColorTransferFunctionWidget"; }

QString vtkQtColorTransferFunctionWidgetPlugin::domXml() const
{
    return QLatin1String(
        "<widget class=\"vtkQtColorTransferFunctionWidget\" name=\"vtkQtColorTransferFunctionWidget\">\n"
        " <property name=\"geometry\">\n"
        "  <rect>\n"
        "   <x>0</x>\n"
        "   <y>0</y>\n"
...
QString vtkQtColorTransferFunctionWidgetPlugin::group() const { return "vtkQt"; }

QIcon vtkQtColorTransferFunctionWidgetPlugin::icon() const { return QIcon( QPixmap( vtkQtPlugin_xpm ) ); }

QString vtkQtColorTransferFunctionWidgetPlugin::includeFile() const { return "vtkQtColorTransferFunctionWidget.h"; }

QString vtkQtColorTransferFunctionWidgetPlugin::toolTip() const { return "Qt vtkColorTransferFunction edition widget"; }
...
bool vtkQtColorTransferFunctionWidgetPlugin::isContainer() const { return false; }
