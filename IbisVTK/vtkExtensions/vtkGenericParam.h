...
#ifndef VTKGENERICPARAM_H
#define VTKGENERICPARAM_H
...
public:
    ...
    {
        m_items.push_back( make_pair( std::string( itemName ), std::string( itemValue ) ) );
    }
...
{
public:
    vtkComboParamImpl( Target * t, const char * ( Target::*GetCurrentChoicePtr )(),
    ...
    virtual void GetValidChoices( std::vector<std::string> & choices )
    {
        ( m_target->*m_GetValidChoicesPtr )( choices );
    }
...
protected:
    template <class Target>
    void AddComboParam( const char * paramName, const char * ( Target::*GetCurrentChoicePtr )(),
                        void ( Target::*SetCurrentChoicePtr )( const char * ),
                        void ( Target::*GetValidChoicesPtr )( std::vector<std::string> & choices ) )
    {
        vtkGenericParam * p = new vtkComboParamImpl<Target>( dynamic_cast<Target *>( this ), GetCurrentChoicePtr,
                                                             SetCurrentChoicePtr, GetValidChoicesPtr );
