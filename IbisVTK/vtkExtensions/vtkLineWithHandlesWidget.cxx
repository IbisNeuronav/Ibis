...
void vtkLineWithHandlesWidget::ProcessEvents( vtkObject * vtkNotUsed( object ), unsigned long event, void * clientdata,
...
{
    if( this->State == vtkLineWithHandlesWidget::Outside || this->State == vtkLineWithHandlesWidget::Start )
    {
        return;
    }
...
void vtkLineWithHandlesWidget::GetPolyData( vtkPolyData * pd ) { pd->ShallowCopy( this->LineSource->GetOutput() ); }
