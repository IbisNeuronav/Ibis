...
{
    if( this->TextureId != 0 ) glDeleteTextures( 1, &( this->TextureId ) );
    this->TextureId = 0;
}
...
void vtkIbisImagePlaneMapper::UpdateTexture()
{
    ...
    if( this->TextureId != 0 && this->LastInput == input &&
        ( input && input->GetMTime() < this->LastInputTimeStamp.GetMTime() ) )
        return;
