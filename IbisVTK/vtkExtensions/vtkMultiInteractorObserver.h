...
// .NAME vtkMultiInteractorObserver - an abstract superclass for classes observing events invoked by multiple
// vtkRenderWindowInteractor .SECTION Description vtkMultiInteractorObserver is an abstract superclass for subclasses
// that observe events invoked by more than one vtkRenderWindowInteractor. These subclasses are typically things like 3D
// widgets; objects that interact with actors in the scene, or interactively probe the scene for information.
//
