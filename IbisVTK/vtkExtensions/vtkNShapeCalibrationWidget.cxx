...
void vtkNShapeCalibrationWidget::ProcessEvents( vtkObject * vtkNotUsed( object ), unsigned long event,
...
{
    if( this->State == vtkNShapeCalibrationWidget::Outside || this->State == vtkNShapeCalibrationWidget::Start )
    {
        return;
    }
...
void vtkNShapeCalibrationWidget::SetMiddlePoint( double ratio ) { this->MiddleHandlePosition = ratio; }
...
void vtkNShapeCalibrationWidget::GetPolyData( vtkPolyData * pd ) { pd->ShallowCopy( this->LineSource->GetOutput() ); }
