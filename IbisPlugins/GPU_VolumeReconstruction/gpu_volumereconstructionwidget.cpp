...
void GPU_VolumeReconstructionWidget::slot_finished()
{
    ...
    USAcquisitionObject * selectedUSAcquisitionObject =
        USAcquisitionObject::SafeDownCast( ibisAPI->GetObjectByID( usAcquisitionObjectId ) );
    Q_ASSERT_X( selectedUSAcquisitionObject, "GPU_VolumeReconstructionWidget::slot_finished()",
                "Invalid target US object" );
    ...
    if( reconstructedImage->SetItkImage( m_VolumeReconstructor->GetReconstructedImage() ) )
    {
        ...
        QString feedbackString =
            QString( "Volume Reconstruction finished in %1 secs" ).arg( qreal( reconstructionTime ) / 1000.0 );
...
void GPU_VolumeReconstructionWidget::on_startButton_clicked()
{
    ...
    USAcquisitionObject * selectedUSAcquisitionObject =
        USAcquisitionObject::SafeDownCast( ibisAPI->GetObjectByID( usAcquisitionObjectId ) );
    Q_ASSERT_X( selectedUSAcquisitionObject, "GPU_VolumeReconstructionWidget::on_startButton_clicked()",
                "Invalid target US object" );
    ...
    float usVolumeSpacing =
        ui->usVolumeSpacingComboBox->itemData( ui->usVolumeSpacingComboBox->currentIndex() ).toFloat();
