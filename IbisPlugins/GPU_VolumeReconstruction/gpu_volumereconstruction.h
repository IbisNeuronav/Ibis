...
public:
    ...
    typedef itk::GPUVolumeReconstruction<IbisItkFloat3ImageType> VolumeReconstructionType;
    ...
    vtkTypeMacro( GPU_VolumeReconstruction, vtkObject )
        ...
        VolumeReconstructionPointer GetReconstructor()
    {
        return m_VolReconstructor;
    }
