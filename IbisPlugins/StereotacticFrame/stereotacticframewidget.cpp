...
StereotacticFrameWidget::StereotacticFrameWidget( QWidget * parent )
    : QWidget( parent ), ui( new Ui::StereotacticFrameWidget )
{
    ui->setupUi( this );
}

StereotacticFrameWidget::~StereotacticFrameWidget() { delete ui; }
...
{
    Q_ASSERT_X( m_pluginInterface, "StereotacticFrameWidget::on_show3DFrameCheckBox_toggled()",
                "No plugin interface specified" );
    m_pluginInterface->SetShow3DFrame( checked );
}

void StereotacticFrameWidget::on_showManipulatorsCheckBox_toggled( bool checked )
{
    Q_ASSERT_X( m_pluginInterface, "StereotacticFrameWidget::on_showManipulatorsCheckBox_toggled()",
                "No plugin interface specified" );
...
{
    Q_ASSERT_X( m_pluginInterface, "StereotacticFrameWidget::on_lineEditFrameX_editingFinished()",
                "No plugin interface specified" );
    double framePos[3];
...
{
    Q_ASSERT_X( m_pluginInterface, "StereotacticFrameWidget::on_lineEditFrameY_editingFinished()",
                "No plugin interface specified" );
    double framePos[3];
    ParseFramePosition( framePos );
    m_pluginInterface->SetCursorFromFramePosition( framePos );
...
{
    Q_ASSERT_X( m_pluginInterface, "StereotacticFrameWidget::on_lineEditFrameZ_editingFinished()",
                "No plugin interface specified" );
    double framePos[3];
    ParseFramePosition( framePos );
    m_pluginInterface->SetCursorFromFramePosition( framePos );
