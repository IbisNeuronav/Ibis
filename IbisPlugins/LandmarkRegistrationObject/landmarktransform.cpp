...
LandmarkTransform::~LandmarkTransform() { this->Clear(); }

void LandmarkTransform::SetSourcePoints( vtkSmartPointer<vtkPoints> pts )
{
    if( this->SourcePoints != pts ) this->SourcePoints = pts;
}

void LandmarkTransform::SetTargetPoints( vtkSmartPointer<vtkPoints> pts )
{
    if( this->TargetPoints != pts ) this->TargetPoints = pts;
}
...
bool LandmarkTransform::IsScalingAllowed() { return this->RegistrationTransform->GetMode() != VTK_LANDMARK_RIGIDBODY; }
...
vtkLandmarkTransform * LandmarkTransform::GetRegistrationTransform() { return this->RegistrationTransform; }
