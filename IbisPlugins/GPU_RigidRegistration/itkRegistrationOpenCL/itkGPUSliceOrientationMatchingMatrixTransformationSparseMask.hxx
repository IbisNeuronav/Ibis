...
#ifndef __itkGPUSliceOrientationMatchingMatrixTransformationSparseMask_hxx
#define __itkGPUSliceOrientationMatchingMatrixTransformationSparseMask_hxx
...
GPUSliceOrientationMatchingMatrixTransformationSparseMask< TFixedImage, TMovingImage >
...
::ComputeMovingImageGradient(void)
{
  ...
  defines2 << "#define DIM_2 " << std::endl;
