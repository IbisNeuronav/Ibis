...
#ifndef __itkGPUSliceOrientationMatchingMatrixTransformationSparseMask_h
#define __itkGPUSliceOrientationMatchingMatrixTransformationSparseMask_h
...
class ITK_EXPORT GPUSliceOrientationMatchingMatrixTransformationSparseMask :
  public Object
{
public:
  /** Standard class typedefs. */
  typedef GPUSliceOrientationMatchingMatrixTransformationSparseMask               Self;
  ...
  itkTypeMacro(GPUSliceOrientationMatchingMatrixTransformationSparseMask,
               Object);
  ...
  typedef CovariantVector< InternalRealType, 2 >          SliceGradientType;
...
protected:
  GPUSliceOrientationMatchingMatrixTransformationSparseMask();
  ~GPUSliceOrientationMatchingMatrixTransformationSparseMask();
...
#ifdef  DEBUG
  std::vector<FixedImagePointType>    m_SampleLocations;    
#endif  
  ...
  InternalRealType *  m_cpuFixedGradientBase;
  cl_mem              m_gpuFixedGradientBase;
...
private:
  GPUSliceOrientationMatchingMatrixTransformationSparseMask(const Self &);   //purposely not implemented
...
#include "itkGPUSliceOrientationMatchingMatrixTransformationSparseMask.hxx"
#endif
