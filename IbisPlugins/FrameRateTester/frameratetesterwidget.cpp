...
FrameRateTesterWidget::FrameRateTesterWidget( QWidget * parent )
    : QWidget( parent ), ui( new Ui::FrameRateTesterWidget )
{
    ui->setupUi( this );
}

FrameRateTesterWidget::~FrameRateTesterWidget() { delete ui; }
...
void FrameRateTesterWidget::UpdateUi()
{
    ...
    int currentIndex =
        GuiUtilities::ObjectComboBoxIndexFromObjectId( ui->currentViewComboBox, m_pluginInterface->GetCurrentViewID() );
