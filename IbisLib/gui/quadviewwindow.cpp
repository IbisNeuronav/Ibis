...
void QuadViewWindow::SetSceneManager( SceneManager * man )
{
    Q_ASSERT( man );
    View * view;
    view = man->CreateView( TRANSVERSE_VIEW_TYPE, 0 );
    ...
    man->SetMainTransverseViewID(0);

    view = man->CreateView( THREED_VIEW_TYPE, 1 );
    ...
    man->SetMain3DViewID( 1 );

    view = man->CreateView( CORONAL_VIEW_TYPE, 2 );
    ...
    man->SetMainCoronalViewID( 2 );

    view = man->CreateView( SAGITTAL_VIEW_TYPE, 3 );
