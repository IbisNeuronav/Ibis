...
private slots:
    ...
    void on_fogMinDistanceSpinBox_valueChanged(double arg1);
    void on_fogMaxDistanceSpinBox_valueChanged(double arg1);
    void on_enableFogCheckBox_toggled(bool checked);
