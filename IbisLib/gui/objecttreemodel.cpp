    ...
    , m_sceneManager( man )
{
    ...
    connect( m_sceneManager, SIGNAL(ObjectVisibilityChanged( SceneObject*)), this, SLOT(SetVisibilityCheck( SceneObject*)) );
...
void ObjectTreeModel::SetVisibilityCheck( SceneObject *obj )
{
