...
AboutPluginsWidget::AboutPluginsWidget(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::AboutPluginsWidget)
{
    ui->setupUi(this);
    UpdateUI();
}

AboutPluginsWidget::~AboutPluginsWidget()
{
    delete ui;
}
...
void AboutPluginsWidget::UpdateUI()
{
    ...
    if( allPlugins.size() > 0 )
        ui->pluginListWidget->setCurrentItem( items[ 0 ] );
