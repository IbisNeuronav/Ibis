...
public:
    ...
    bool IsFogEnabled() { return m_fogEnabled; }
    void SetFogMinDistance( double dist );
    double GetFogMinDistance() { return m_fogMinDistance; }
    void SetFogMaxDistance( double dist );
    double GetFogMaxDistance() { return m_fogMaxDistance; }
...
protected:
    ...
    bool m_isAnimating;
    double m_multFactor;
    double m_fogMinDistance;
    double m_fogMaxDistance;
    bool m_fogEnabled;
